...
class ThermalCamera:
    ...
    def mouse_callback(self, event, x, y, flags, param, therm_frame, file, cam_id):
    ...
    def on_frame(self, camera, camera_frame, file):
        ...
        cv2.setMouseCallback('image', lambda event, x, y, flags, param: self.mouse_callback(event, x, y, flags, param, therm_frame, file, camera_id))


        cv2.imshow("image", frame200) # Show the thermal image using OpenCV
